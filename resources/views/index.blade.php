...
<body class="overflow-auto overflow-y-auto bg-body" data-astro-cid-sckkx6r4>
    ...
    <div class="mx-auto max-w-7xl w-full px-5 sm:px-8 md:px-14 lg:px-5 undefined">
      ...
      <div data-navbar
        ...
        <ul
          ...
          <li> <a href="#services" class="duration-300 font-medium ease-linear hover:text-primary py-3"> Our Services
            </a> </li>
          <li> <a href="#about-us" class="duration-300 font-medium ease-linear hover:text-primary py-3"> About Us </a>
          </li>
          <li> <a href="#exp" class="duration-300 font-medium ease-linear hover:text-primary py-3"> Experience </a>
          </li>
        </ul>
        <div
          ...
          <a href="#cta"
            ...
            <span class="relative text-white z-10"> Contact Us </span> </a> </div>
      ...
      <div class="mx-auto max-w-7xl w-full px-5 sm:px-8 md:px-14 lg:px-5 flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
          <h1 class="text-3xl/tight sm:text-4xl/tight md:text-5xl/tight xl:text-6xl/tight
            ...
            Small Business <span class="text-heading-4 text-combine text-combine-up">Administrative</span> services.
          </h1>
          <p class="md:text-xl text-heading-3 mt-8">
            We provide administrative and social media marketing support to small to medium size businesses helping them
    ...
    <section id="about-us">
      <div class="mx-auto max-w-7xl w-full px-5 sm:px-8 md:px-14 lg:px-5 flex flex-col midmd:flex-row gap-10 lg:gap-12">
        ...
        <div class="flex-1 flex midmd:w-7/12 lg:w-1/2 flex-col">
          ...
          <p class="md:text-xl text-heading-3 mt-8">
            Admisa Group is a company that offers administrative, accounting and marketing services to small businesses
            to optimize their resources and improve their productivity. <br>Our team is made up of professionals
            specialized in various areas such as: administrative, accounting and marketing.
          </p>
    ...
    <section id="exp">
      <div class="mx-auto max-w-7xl w-full px-5 sm:px-8 md:px-14 lg:px-5 flex flex-col midmd:flex-row gap-10 lg:gap-12">
        <div class="flex-1 flex midmd:w-7/12 lg:w-1/2 flex-col">
          ...
          <p class="md:text-xl text-heading-3 mt-8">
            I have gained my experience through the
            administration of my own business. Over the years, I
            have taken various responsibilities such as managing
            finances, overseeing operations, handling customers
            relations and developing strategic plans. <br> This hands
            on experience has given me a deep understanding of
            the intricacies involved in running a business
            efficiently. Overall, administrating my own business
            has provided me with invaluable knowledge and
            expertise that I can now apply to help other business
            owners.
          </p>
          <ul class="mt-8 space-y-4 text-heading-3 font-medium">
            ...
            <li> <span
                class="font-bold bg-box-bg rounded-full w-8 h-8 mr-3 text-primary inline-flex justify-center items-center">&checkmark;</span>
              Salesforce's certification.
            </li>
            <li> <span
                class="font-bold bg-box-bg rounded-full w-8 h-8 mr-3 text-primary inline-flex justify-center items-center">&checkmark;</span>
              Passion about helping you.
            </li>
          </ul>
        </div>
        <div
      ...
      <div class="mx-auto max-w-7xl w-full px-5 sm:px-8 md:px-14 lg:px-5 undefined">
        <div class="w-full relative py-8 md:py-10 px-6 md:px-8 rounded-2xl bg-gradient-to-tr from-gray-100 to-gray-200">
          ...
          font-bold text-heading-1">
              Contact Us <span class="text-heading-4">Now</span> </h1>
            <form method="POST" action="/registro" class="mx-auto max-w-md sm:max-w-xl pt-10"> 
            @csrf  
            <input type="text"
                placeholder="First Name" name="nombre" id="firstName"
                class="w-full p-3 mt-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary">
              <input type="text" placeholder="Last Name" name="apellido" id="lastName"
                class="w-full p-3 mt-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary">
              <input type="email" placeholder="E-Mail" name="email" id="email"
                class="w-full p-3 mt-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary">
              <!-- <PhoneInput /> -->
              <div class="flex flex-col"> <input type="tel" placeholder="Phone" name="telefono" id="phone"
              ...
              min-w-max
              text-white" onclick=""> <span
                    class="text-center hidden sm:flex relative z-[5]">Send</span> <span
        ...
        <div class="grid md:grid-cols-2 gap-8 h-max">
          <nav class="space-y-6">
            ...
            <ul class="space-y-3 font-medium md:text-lg text-heading-3">
              <li> <a href="#services" class="transition hover:text-primary"> Our Services </a> </li>
              <li> <a href="#about-us" class="transition hover:text-primary"> About Us </a> </li>
              <li> <a href="#exp" class="transition hover:text-primary"> Experience </a> </li>
            </ul>
          </nav>
        </div>
      </div>
    ...
    <div class=" bg-gradient-to-tl from-box-bg py-2 relative">
      <div class="mx-auto max-w-7xl w-full px-5 sm:px-8 md:px-14 lg:px-5 undefined">
        <div class="flex justify-between items-center gap-6 md:text-lg text-heading-3">
          <div>
            &copy; <span id="year"></span> Admisa Group. All rights reserved.
          </div>
        </div>
      </div>
    </div>
